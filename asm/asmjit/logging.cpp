...
// [Guard]
#include "source/includes/asm/asmjit/asmjit_build.h"
#if !defined(ASMJIT_DISABLE_LOGGING)

// [Dependencies]
#include "source/includes/asm/asmjit/base/codeholder.h"
#include "source/includes/asm/asmjit/base/codeemitter.h"
#include "source/includes/asm/asmjit/base/logging.h"
#include "source/includes/asm/asmjit/base/utils.h"

#if !defined(ASMJIT_DISABLE_BUILDER)
# include "source/includes/asm/asmjit/base/codebuilder.h"
#endif // !ASMJIT_DISABLE_BUILDER

#if !defined(ASMJIT_DISABLE_COMPILER)
# include "source/includes/asm/asmjit/base/codecompiler.h"
#else
namespace asmjit { class VirtReg; }
#endif // !ASMJIT_DISABLE_COMPILER

#if defined(ASMJIT_BUILD_X86)
# include "source/includes/asm/asmjit/x86/x86logging_p.h"
...
// [Api-Begin]
#include "source/includes/asm/asmjit/asmjit_apibegin.h"
...
// [Api-End]
#include "source/includes/asm/asmjit/asmjit_apiend.h"
