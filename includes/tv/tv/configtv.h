...
#define TVCONFIG_TVSRC "../../include /dbase/debug/tv/tvision/include /usr/include/rhtvision"
#define TVCONFIG_RHIDE_OS_LIBS "stdc++ m gpm"
#define TVCONFIG_TVOBJ "/usr/lib ../../makes /dbase/debug/tv/tvision/makes "
#define TVCONFIG_STDCPP_LIB "-lstdc++"
#define TVCONFIG_SHARED_CODE_OPTION "-fPIC"
#define TVCONFIG_RHIDE_LDFLAGS "-lgpm -lstdc++ -lm -lc"
#define TVCONFIG_LIB_VER "2.1.0"
#define TVCONFIG_LIB_VER_MAJOR "2"
#define TVCONFIG_EXTRA_INCLUDE_DIRS ""
#define TVCONFIG_CFLAGS   "-O2 -pipe -Wno-packed"
#define TVCONFIG_CXXFLAGS "-O2 -pipe -Wno-packed"
#define TVCONFIG_REF_DIR  "/dbase/debug/tv/tvision"
